# Version: 0.0.1
FROM ubuntu:14.04
MAINTAINER GhostKU <dev@ghostku.com>
...
#Install script
COPY nod32upd $NOD_FOLDER
COPY webface $NOD_FOLDER/mirror
RUN sed -i -e 's/^pathToSaveBase=.*/pathToSaveBase=\"\/var\/www\/html\/\";/g' $NOD_FOLDER/settings.cfg;\
